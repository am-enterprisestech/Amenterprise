    ...
    <div className="grid min-h-screen place-items-center bg-muted/40 px-5 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
          ...
          {/* Quick Access Credentials & Direct Launch */}
          <div className="mt-6 border-t border-border pt-6">
            <h3 className="mb-2 font-display text-xs font-bold uppercase tracking-wider text-muted-foreground">
              Direct Quick Access — All Department Portals
            </h3>
            <p className="mb-3 text-[11px] text-muted-foreground">
              Explore department-specific workspaces directly without manual password entry:
            </p>

            <div className="grid grid-cols-2 gap-2">
              <Link
                to="/staff/dashboard"
                className="rounded-xl border border-border bg-muted/40 p-2.5 text-center text-xs font-bold text-foreground hover:bg-muted"
              >
                Project Manager
              </Link>
              <Link
