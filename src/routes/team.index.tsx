...
export const Route = createFileRoute("/team/")({
  head: () => ({
    meta: [
      { title: "Our Directors & Founding Story — AM Enterprises" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Our Directors & Founding Story — AM Enterprises" },
      {
...
function DirectorsPage() {
  ...
  // Dynamically fetch and merge images & profile data from Supabase database
  ...
  return (
    <>
      <PageHeader
        ...
        description="Meet the Board of Directors steering AM Enterprises. Senior leadership directly involved in full-stack architecture, AI automation engines, and Meta growth tracking."
      />
      ...
      {/* =========================================================
          BOARD OF DIRECTORS SHOWCASE (IMAGES FROM DB)
      ========================================================= */}
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-10">
          <div className="mb-12 text-center">
            ...
            <p className="mt-2 text-sm text-body-text max-w-2xl mx-auto leading-relaxed">
              Every client project is directed by our founding leaders. Profiles and images are dynamically synced from our live central directory.
            </p>
          </div>
      ...
      <section className="bg-white py-16 border-t border-espresso/10">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-cocoa/20 bg-sand/60 px-4 py-1.5 text-xs font-bold text-cocoa">
            <UserCheck className="h-4 w-4" /> Direct Accountability Guarantee
          </span>
          <h3 className="mt-4 font-display text-2xl font-black text-espresso sm:text-3xl">
            You will always work directly with senior leadership.
          </h3>
          <p className="mt-3 text-sm text-body-text max-w-2xl mx-auto leading-relaxed">
            At AM Enterprises, we don't hand your enterprise vision to junior interns. Every project architecture, automation workflow, and Meta attribution setup is personally reviewed and executed under the direction of our Board of Directors.
          </p>
          <div className="mt-8">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 rounded-2xl bg-cocoa px-7 py-3.5 text-sm font-bold text-white shadow-soft transition hover:bg-copper"
            >
              Start Project with Directors <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
